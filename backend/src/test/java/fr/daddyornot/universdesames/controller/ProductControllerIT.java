...
class ProductControllerIT {
    ...
    void shouldReturnAllProducts_PublicAccess() throws Exception {
        // GIVEN
        ProductDTO p1 = new ProductDTO(1L, "Pierre", "Desc", 10.0, "Quartz", "img.jpg", ProductType.PHYSICAL, null, null, null);
    ...
    void shouldCreateProduct_WhenAdmin() throws Exception {
        // GIVEN
        ProductDTO newProduct = new ProductDTO(null, "Nouveau", "Desc", 20.0, null, "img.jpg", ProductType.PHYSICAL, null, null, null);
        given(productService.saveProduct(any())).willReturn(new ProductDTO(1L, "Nouveau", "Desc", 20.0, null, "img.jpg", ProductType.PHYSICAL, null, null, null));
    ...
    @Test
    @WithMockUser(roles = "USER") // Simule un simple utilisateur
